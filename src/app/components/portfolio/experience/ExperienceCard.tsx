...
export default function ExperienceCard() {
    ...
    return (
        <article>
            <section className={`w-full h-[7rem] pl-5 shadow-md flex justify-between ${isOpen ? 'rounded-t-md' : 'rounded-md'} hover:bg-theme-gray hover:bg-opacity-10 duration-100`}>
                {/* Information */}
                <div className="py-2 flex justify items-center gap-5">
                    ...
                    <header className="w-full h-full p-2 flex flex-col">
                        <h2 className="tracking-wide text-theme-main">Google Developer's Student Club</h2>
                        <h3 className="text-sm tracking-tighter font-bold">Technical Co-Lead</h3>
            ...
            {/* Drop down content */}
            <section className={`w-full rounded-b-md bg-theme-main ${isOpen ? 'opacity-100 p-3 h-[8rem]' : 'h-[0rem] p-0 select-none'} duration-300`}>
