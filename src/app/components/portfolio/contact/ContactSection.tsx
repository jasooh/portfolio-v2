        ...
        <section className="w-full h-fit min-h-[40rem] flex flex-col items-center rounded-md">
            <section className="flex flex-col items-center">
                ...
                <header className="flex flex-row items-center gap-2 mb-5">
                    ...
                    <a className="hover:text-theme-main duration-300" href="mailto:abuyuanjustin@gmail.com">abuyuanjustin@gmail.com</a>
                </header>
                ...
                <section className="flex flex-row gap-3 mb-8">
                    <button><FaGithub className="size-14 hover:text-theme-main duration-300"/></button>
                    <button><FaLinkedin className="size-14 hover:text-theme-main duration-300"/></button>
                </section>
                <section className="text-center text-sm">
                    <p>Built with love using <strong>Next.js</strong> and <strong>Tailwind CSS</strong>, and deployed on <strong>GitHub Pages</strong>.</p>
